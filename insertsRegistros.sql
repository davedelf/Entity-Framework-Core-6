...
insert into Generos (NombreGenero)values('Fantasía')
insert into Generos (NombreGenero)values('Comedia')
insert into Generos (NombreGenero)values('Drama')
insert into Generos (NombreGenero)values('Romance')
insert into Generos (NombreGenero)values('Terror')
insert into Generos (NombreGenero)values('Suspenso')
insert into Generos (NombreGenero)values('Misterio')
insert into Generos (NombreGenero)values('Crimen')
insert into Generos (NombreGenero)values('Western')
insert into Generos (NombreGenero)values('Animación')
insert into Generos (NombreGenero)values('Musical')
insert into Generos (NombreGenero)values('Documental')
insert into Generos (NombreGenero)values('Biográfico')
insert into Generos (NombreGenero)values('Fantasía científica')
insert into Generos (NombreGenero)values('Superhéroes')
insert into Generos (NombreGenero)values('Guerra')
insert into Generos (NombreGenero)values('Romántica')

INSERT INTO Actores (Nombre, Biografia, FechaNacimiento) VALUES
('Ana López', 'Actriz de renombre en la industria cinematográfica.', '01/01/2000'),
('Javier Pérez', 'Actor versátil con una gran trayectoria en teatro y cine.', '15/03/2001'),
('Isabel Rodríguez', 'Conocida por sus papeles en películas de drama.', '20/05/2002'),
('Carlos Martínez', 'Actor de comedia con un gran sentido del humor.', '10/07/2003'),
('Elena Sánchez', 'Actriz talentosa que ha trabajado en producciones internacionales.', '05/09/2004'),
('Miguel Fernández', 'Actor comprometido con roles sociales y políticos.', '02/11/2005'),
('Carmen García', 'Reconocida por su interpretación en películas de época.', '08/12/2006'),
('Luis Morales', 'Actor joven con un prometedor futuro en la industria.', '14/02/2007'),
('María Torres', 'Actriz destacada en películas de acción y aventura.', '23/04/2008'),
('José González', 'Intérprete carismático con una gran base de fanáticos.', '30/06/2009'),
('Laura Pérez', 'Actriz con una voz increíble que también canta en musicales.', '17/08/2010'),
('Antonio Ruiz', 'Actor de carácter que ha interpretado una amplia gama de roles.', '25/10/2011'),
('Paula Fernández', 'Ganadora de varios premios por sus actuaciones en el cine.', '19/12/2012'),
('Daniel Martín', 'Actor que ha trabajado en películas de ciencia ficción.', '03/01/2013'),
('Sofía López', 'Actriz joven que ha ganado popularidad en películas para adolescentes.', '12/03/2014'),
('Pablo García', 'Intérprete apasionado por el teatro clásico.', '27/05/2015'),
('Lucía Rodríguez', 'Actriz que ha participado en películas de misterio y suspense.', '06/07/2016'),
('Adrián Sánchez', 'Actor que ha trabajado en películas de terror.', '11/09/2017'),
('Eva Pérez', 'Actriz versátil que ha trabajado en comedia y drama.', '28/11/2018'),
('Mario Torres', 'Ganador de un premio Oscar por su actuación en una película biográfica.', '09/01/2019'),
('Sara Martínez', 'Actriz de teatro que también ha incursionado en el cine.', '18/03/2020'),
('Fernando González', 'Actor con una amplia experiencia en televisión.', '24/05/2021'),
('Lara Ruiz', 'Estrella en ascenso en el mundo del cine independiente.', '04/07/2022'),
('Raúl Morales', 'Actor carismático que ha trabajado en películas de comedia romántica.', '15/09/2023');
INSERT INTO Actores (Nombre, Biografia, FechaNacimiento) VALUES
('Luisa García', 'Actriz de renombre en el teatro y el cine.', '22/11/2000'),
('Andrés Pérez', 'Actor conocido por su versatilidad en diferentes géneros.', '14/03/2001'),
('Marina Rodríguez', 'Actriz apasionada por los personajes dramáticos.', '07/05/2002'),
('Roberto Martínez', 'Actor destacado en comedias de situación.', '18/07/2003'),
('Julia Sánchez', 'Actriz versátil que ha trabajado en cine y televisión.', '30/09/2004'),
('Diego Fernández', 'Actor comprometido con causas sociales.', '12/12/2005'),
('Sofía López', 'Reconocida por su actuación en películas de época.', '25/02/2007'),
('Gonzalo Morales', 'Actor joven con gran potencial en la industria.', '08/04/2008'),
('Valentina Torres', 'Actriz versátil que ha interpretado roles de acción.', '21/06/2009'),
('Martín González', 'Actor carismático que ha ganado seguidores leales.', '03/08/2010'),
('Cecilia Ruiz', 'Actriz con una voz impresionante en musicales.', '15/10/2011'),
('Felipe Sánchez', 'Actor conocido por su versatilidad en la actuación.', '27/12/2012'),
('Laura Pérez', 'Ganadora de premios por sus destacadas actuaciones.', '09/02/2014'),
('Javier Martín', 'Actor que ha trabajado en películas de ciencia ficción.', '23/04/2015'),
('Camila López', 'Actriz que se ha destacado en películas para adolescentes.', '06/06/2016'),
('Lucas Fernández', 'Intérprete apasionado por el teatro clásico.', '19/08/2017'),
('Isabella Rodríguez', 'Actriz que brilla en películas de misterio y suspense.', '02/10/2018'),
('Alexandra Pérez', 'Actriz que ha dejado huella en películas de terror.', '14/12/2019'),
('Mateo Torres', 'Actor versátil que se desenvuelve en comedia y drama.', '26/02/2021'),
('Paulina García', 'Ganadora de un premio Oscar por una película biográfica.', '10/04/2022'),
('Joaquín Morales', 'Actor apasionado por el teatro y el cine independiente.', '22/06/2023'),
('Alicia Sánchez', 'Estrella en ascenso en el mundo de la televisión.', '04/08/2000'),
('Hugo Martínez', 'Actor talentoso en papeles dramáticos.', '17/10/2001'),
('Valeria Fernández', 'Actriz que se destaca en películas de aventuras.', '29/12/2002'),
('Gabriel Pérez', 'Actor cómico con una gran habilidad para la improvisación.', '11/02/2004'),
('Carolina González', 'Actriz que ha trabajado en producciones internacionales.', '24/04/2005'),
('Joaquín Rodríguez', 'Actor comprometido con causas sociales.', '07/06/2006'),
('Isabel López', 'Actriz versátil con una amplia gama de roles.', '20/08/2007'),
('Matías Torres', 'Actor joven que ha ganado popularidad en comedias románticas.', '02/10/2008'),
('Sara Martínez', 'Actriz carismática con un toque de comedia.', '15/12/2009'),
('Lucas Sánchez', 'Actor apasionado por el teatro clásico.', '28/02/2011'),
('Valentina García', 'Actriz conocida por sus papeles en películas de acción.', '12/04/2012'),
('Maximiliano Pérez', 'Actor versátil que se ha destacado en el cine de autor.', '25/06/2013'),
('María Rodríguez', 'Actriz que ha trabajado en películas de suspenso.', '07/08/2014'),
('Diego Martínez', 'Ganador de premios por sus actuaciones en el cine independiente.', '20/10/2015'),
('Lorena Sánchez', 'Actriz que brilla en el cine de terror.', '02/12/2016'),
('Carlos López', 'Actor carismático que ha ganado popularidad en comedia.', '14/02/2018'),
('Catalina Torres', 'Actriz apasionada por el cine de ciencia ficción.', '28/04/2019'),
('Juan García', 'Actor que ha interpretado a superhéroes en películas.', '10/06/2020'),
...
VALUES
  ('Hoyts Abasto', geography::STPointFromText('POINT(-34.6032898 -58.4108409)', 4326)),
  ('Cinemark Avellaneda', geography::STPointFromText('POINT(-34.6610386 -58.3875306)', 4326)),
  ('Cinemark Caballito', geography::STPointFromText('POINT(-34.6163238 -58.4493937)', 4326)),
  ('Hoyts DOT', geography::STPointFromText('POINT(-34.5460556 -58.491631)', 4326)),
  ('Cinemark Malvinas Argentinas', geography::STPointFromText('POINT(-34.5305614 -58.7054465)', 4326)),
  ('Cinemark Mendoza', geography::STPointFromText('POINT(-32.9547993 -68.8620981)', 4326)),
  ('Hoyts Moreno', geography::STPointFromText('POINT(-34.6344919 -58.7952226)', 4326)),
  ('Hoyts Moron', geography::STPointFromText('POINT(-34.6347535 -58.6324081)', 4326)),
  ('Cinemark Neuquen', geography::STPointFromText('POINT(-38.9411691 -68.0668683)', 4326)),
  ('Hoyts Nuevocentro', geography::STPointFromText('POINT(-31.4123878 -64.2079977)', 4326)),
  ('Cinemark Palermo', geography::STPointFromText('POINT(-34.5865167 -58.4127763)', 4326)),
  ('Hoyts Patio Olmos', geography::STPointFromText('POINT(-31.4198956 -64.1906584)', 4326)),
  ('Cinemark Puerto Madero', geography::STPointFromText('POINT(-34.6210744 -58.3695077)', 4326)),
  ('Hoyts Quilmes', geography::STPointFromText('POINT(-34.7582624 -58.2766077)', 4326)),
  ('Hoyts Rosario', geography::STPointFromText('POINT(-32.9102092 -60.6858926)', 4326)),
  ('Hoyts Salta', geography::STPointFromText('POINT(-24.7814253 -65.4077764)', 4326)),
  ('Cinemark Salta', geography::STPointFromText('POINT(-24.8323806 -65.4285234)', 4326)),
  ('Cinemark San Justo', geography::STPointFromText('POINT(-34.6868697 -58.5551345)', 4326)),
  ('Cinemark Santa Fe', geography::STPointFromText('POINT(-31.6509906 -60.7010876)', 4326)),
  ('Cinemark Soleil', geography::STPointFromText('POINT(-34.491282 -58.591887)', 4326)),
  ('Hoyts Temperley', geography::STPointFromText('POINT(-34.7825643 -58.4062024)', 4326)),
