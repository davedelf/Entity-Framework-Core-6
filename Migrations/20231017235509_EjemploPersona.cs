            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "Personas",
                        principalColumn: "Id",
                        /*el onDelete nos permite personalizar el comportamiento de la aplicacion y bd cuando eliminemos una entidad principal.
                         Elegimos Restrict cuando queremos lanzar una ecepción si se intenta eliminar una persona que tenga mensajes.s*/
                        onDelete: ReferentialAction.Restrict);
                });
